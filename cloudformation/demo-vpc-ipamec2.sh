...
aws cloudformation create-stack \
  ...
  --parameters \
    ParameterKey=ec2KEYNAME,ParameterValue=management \
    ParameterKey=ec2ROLENAME,ParameterValue=ROLE-SSMAdminAccess \
    ParameterKey=regiononeVPCCIDR,ParameterValue=10.2.0.0/16 \
    ParameterKey=regiononePUBLICSUBNETONE,ParameterValue=10.2.0.0/18 \
    ParameterKey=regiononePUBLICSUBNETTWO,ParameterValue=10.2.64.0/18
