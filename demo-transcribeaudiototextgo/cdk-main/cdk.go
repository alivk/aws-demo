...
func demotranscribeaudiototextgo(scope constructs.Construct, id string, props *LambdaTranscribeAudioToTextGolangStackProps) awscdk.Stack {
	...
	sourceBucket := awss3.NewBucket(stack, jsii.String("demo-transcribeaudiototextgo-source-"), &awss3.BucketProps{
	...
	outputBucket := awss3.NewBucket(stack, jsii.String("demo-transcribeaudiototextgo-destination-"), &awss3.BucketProps{
		BlockPublicAccess: awss3.BlockPublicAccess_BLOCK_ALL(),
		RemovalPolicy:     awscdk.RemovalPolicy_DESTROY,
		AutoDeleteObjects: jsii.Bool(true),
	...
	function := awscdklambdagoalpha.NewGoFunction(stack, jsii.String("demo-transcribeaudiototextgo-function"),
	...
	awscdk.NewCfnOutput(stack, jsii.String("demo-transcribeaudiototextgo-source"),
		&awscdk.CfnOutputProps{
			ExportName: jsii.String("demo-transcribeaudiototextgo-source"),
			Value:      sourceBucket.BucketName()})

	awscdk.NewCfnOutput(stack, jsii.String("demo-transcribeaudiototextgo-destination"),
		&awscdk.CfnOutputProps{
			ExportName: jsii.String("demo-transcribeaudiototextgo-destination"),
...
func main() {
	...
	demotranscribeaudiototextgo(app, "demo-demotranscribeaudiototextgo", &LambdaTranscribeAudioToTextGolangStackProps{
		awscdk.StackProps{
			Env: env(),
		},
	})
